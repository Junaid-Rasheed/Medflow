        ...
        >
          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-20  lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-snug text-gray-400 2xl:font-PoppinRegular 2xl:text-md  tracking-wide  leading-relaxed pt-6">
                {data
          ...
          >
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mt-6  lg:mt-0">
              ...
              {isSmallDevice ? (
                ...
                <p className="text-gray-400 2xl:w-5/6 2xl:font-PoppinRegular  pt-6 pr-10 tracking-wide leading-snug 2xl:text-md">
